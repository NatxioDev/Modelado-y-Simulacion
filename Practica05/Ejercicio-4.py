...
beta2 = (((lnx1*sumlnx1)-(lnx2*sumlnx1)) /
         ((sumlnx1x2*((lnx1*sumlnx2)-(sumlnx1x2)) -
           (sumlnx1*((lnx2-(lnx1*sumlnx2pow2)) -
                     (sumlnx1*sumlnx2pow2))))))

beta1 = ((beta2*((sumlnx1x2)-lnx2*sumlnx1)) /
         ((lnx1*sumlnx1)-(sumlnx1pow2)))

beta0 = lny+(beta1*lnx1)+(beta2*lnx2)
...
def realizarPrueba():
    ...
    print(f"{bcolors.HEADER}Ejercicio 4: \n{bcolors.ENDC}")
    print(
